  ...
  return (
    <div className="text-white grid grid-cols-2 tablet:grid-cols-1">
      <div className="mt-32 xsmobile:mt-4 mobile:mt-8">
        ...
        {!currentUser && <Text><TextLink href="#">Sign Up</TextLink> or <TextLink href="#">Log in</TextLink> to start</Text>}
        {currentUser && <Text><TextLink href="#">Click here</TextLink> to start</Text>}
      </div >
